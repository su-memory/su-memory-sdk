...
class TemporalCore:
    ...
    def __repr__(self) -> str:
        return "TemporalCore(cycle_length=60)"
...
def _run_tests():
    ...
    logger.debug("=" * 60)
    logger.debug("TemporalCore Test Suite")
    logger.debug("=" * 60)
    ...
    test("ZI is yang", tc.is_branch_yang(TimeBranch.ZI))
    test("CHOU is yin", not tc.is_branch_yang(TimeBranch.CHOU))
