...
class ErrorHint:
    ...
    ERROR_CATALOG: dict[str, dict] = {
        ...
        "EMBED_001": {
            ...
            "causes": ["未安装任何嵌入服务", "API Key 未配置", "网络连接失败", "Ollama 服务未启动"],
            "solutions": [
                "方案1 (推荐): 安装 Ollama\n"
        ...
        "EMBED_002": {
            ...
            "causes": ["不同嵌入服务生成的向量维度不同", "更换嵌入服务后未重建索引"],
            "solutions": [
        ...
        "FAISS_001": {
            ...
            "causes": ["FAISS 未安装或安装失败", "使用的是不支持 FAISS 的平台"],
            "solutions": [
        ...
        "STORAGE_001": {
            ...
            "causes": ["指定路径不存在且无法创建", "路径权限不足", "磁盘空间不足"],
            "solutions": [
        ...
        "MEM_001": {
            ...
            "causes": ["已达到 max_memories 限制", "内存管理策略导致旧记忆被清理"],
            "solutions": [
        ...
        "SESSION_001": {
            "title": "会话数据丢失",
            "symptom": "跨会话召回功能不正常",
            "causes": ["会话未正确保存", "存储路径配置问题", "会话 ID 不一致"],
            "solutions": [
...
class DiagnosticTool:
    ...
    def run_diagnostics() -> dict:
        ...
        results = {
            "python": {"version": sys.version, "executable": sys.executable, "path": sys.path[:3]},
            "environment": {
