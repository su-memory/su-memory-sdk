...
class VectorGraphRAG:
    ...
    def _faiss_semantic_search(
        ...
        try:
            ...
            D, I = self._faiss_index.search(query_np, min(top_k, len(self._id_map)))
    ...
    def _find_neighbors(
        ...
        node_vec = self.node_vectors.get(node_id, [0.0] * self.dims)
...
def create_vector_graph_rag(
    ...
    if embedding_func is None:
        ...
        try:
            ...
            print(f"[VectorGraphRAG] 使用 Hash fallback")
